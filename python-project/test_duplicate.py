...
def test_count_all_stars():
    try:
        ...
        assert dup1 == "Order 66", "Running count_all_stars([\"Order 66\", \"Order 66\"])... Expected \"Order 66\", got {}".format(dup1)
        dup2 = find_duplicate(["Only hope", "Order 66", "Order 66", "Obiwan Kenobi"])
        assert dup2 == "Order 66", "Running count_all_stars([\"Only hope\", \"Order 66\", \"Order 66\", \"Obiwan Kenobi\"])... Expected \"Order 66\", got {}".format(dup2)
